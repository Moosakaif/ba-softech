  ...
  return (
    ...
    <div className={`${font.className} flex flex-col bg-black items-center justify-center md:items-start p-4`}>
          ...
          <p className="text-white leading-relaxed p-4">
                ...
                <p className="text-white leading-relaxed px-4">
                By providing your phone number, you consent to its use strictly for the purposes stated above. Consent is obtained through the Contact Form, and you may withdraw consent at any time by contacting us at <span className='text-cards'>info@basoftech.com</span>.
                </p>
                <h2 className="text-4xl font-oswald text-cards  p-4">
                ...
                <p className="text-white leading-relaxed px-4">
                You may request access to, correction of, or deletion of your phone number from our systems by contacting <span className='text-cards'>info@basoftech.com</span>.
                </p>
                <h2 className="text-4xl font-oswald text-cards  p-4">
                Example For Direct Use
                </h2>
                <p className="text-white leading-relaxed px-4">
                "We collect phone numbers solely to contact. Your phone number and consent will never be shared with third-party providers, advertisers, or external organizations unless explicitly required by law or to fulfill services you’ve requested (e.g., SMS delivery). All data is secured and retained only for as long as necessary. You may withdraw consent or request deletion at any time by contacting info@basoftech.com."
                </p>
        </div>
        <Footer/>
    </div>
