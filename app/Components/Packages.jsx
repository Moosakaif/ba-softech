  ...
  return (
    <section className={`${font.className} flex flex-col text-white justify-center items-center p-12 bg-black z-50`}>
      ...
      <div className="flex space-x-4 justify-center items-center mt-8">
        ...
        <button onClick={changeRegionCan} className={`px-4 py-2 z-50 rounded-md transition-all duration-300 ${region == "Australia" ? "bg-cards text-black font-bold" : "bg-gray-700 hover:bg-gray-600"}`}></button>
